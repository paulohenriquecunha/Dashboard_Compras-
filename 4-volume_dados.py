...
data_defaut = df_compras.index.date.max()
data_inicio = st.sidebar.date_input('Data Inicial', data_defaut - timedelta(days=6))
data_final = st.sidebar.date_input('Data Final', data_defaut)
...
col31.metric('Comissão no Período', valor_comissao_vendedor)
